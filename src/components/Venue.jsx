  ...
  return (
    ...
    <div className='bg-black font-cinzel' style={{"text-transform":"none"}}>
        ...
        <div className="flex flex-wrap sm:flex-nowrap justify-center gap-10 px-4 py-3 mt-8 z-10">
            <div className={small_header ? "opacity-10 sm:opacity-100 search rounded-xl flex min-w-[300px] bg-slate-100 h-fit font-bold px-3 py-5 relative justify-center items-center" :"search rounded-xl flex min-w-[300px] bg-slate-100 h-fit font-bold px-3 py-5 relative justify-center items-center"  }>
            ...
            <div className="flex flex-wrap gap-10 items-center justify-center pb-10">
             <Link to="/luxeview">  <div className="card flex flex-col max-w-[300px] min-w-[260px] h-[350px] bg-white rounded-2xl">
