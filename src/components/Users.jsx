...
import bookingsection from "../assets/Users/user.png"
          ...
          <div className="realtive overflow-x-auto">
            <table className="w-full text-white table-auto font-cinzel text-sm sm:text-lg whitespace-nowrap font-bold border-collapse" >
                <thead className="w-full " style={{"border":"1px solid #D50AF5","border-radius":"20px"}}>
                    ...
                    <th scope="col" className="px-2 py-2 ">CREATEDAT</th>
                    <th scope="col" className="px-2 py-2">ROLE</th>
                    <th scope="col" className="px-2 py-2">ADMIN TYPE</th>
                ...
                <td className="text-center text-bold p-4">GINA RAY</td>
                    <td className="text-center text-bold p-4">gr45@yahoo.com</td>
                    <td className="text-center  p-4">22/june 2023</td>
