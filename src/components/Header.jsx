  ...
  return (
    <>
        ...
        <ul className="flex flex-1 justify-end items-center font-semibold gap-4 lg:gap-[5%]">
          <li className="relative">
            <button
              ...
              className="flex items-center justify-between w-full py-2 pl-3 pr-4  rounded bg-transparent  "
              onClick={() => {
                handleAdmin_drop(!admin_drop);
              }}
            >
              ADMIN
              <svg
            ...
            {admin_drop && (
              <div
                class="absolute right-0 z-[1000] mt-2 w-48 origin-top-right rounded-xl bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none font-cinzel font-semibold text-black"
                role="menu"
              ...
              >
                <div class="py-1" role="none">
                  ...
                  <a
                    ...
                    id="menu-item-2"
                  >
                    <img src={scan} className="inline" alt="scan ticket" />{" "}
      ...
      <div className="bg-transparent md:hidden flex justify-between items-center font-cinzel font-bold text-white  px-3 py-2 ">
        ...
        <div onClick={()=>{
          handlesmall_header(!small_header)
        }}>
          <Menu />
        </div>
