...
import bookingsection from "../assets/Bookings/bookingsection.png"
          ...
          <div className="realtive overflow-x-auto">
            <table className="w-full text-white table-auto font-cinzel text-sm sm:text-lg whitespace-nowrap font-bold border-collapse" >
                <thead className="w-full " style={{"border":"1px solid #D50AF5","border-radius":"20px"}}>
                    ...
                    <th scope="col" className="px-2 py-2 ">ORDER NUMBER</th>
                    <th scope="col" className="px-2 py-2 ">QUANTITY</th>
                    <th scope="col" className="px-2 py-2">PAYMENT STATUS</th>
                    <th scope="col" className="px-2 py-2">CANCEL BOOKING</th>
                ...
                <td className="text-center text-bold p-4">1.YOGA & HEALTH</td>
                    <td className="text-center text-bold p-4">#3573829172</td>
                    <td className="text-center  p-4">2 x Tickets</td>
                    <td className="text-center p-4"><button className='text-white text-sm font-bold rounded-2xl bg-[#18638F] px-3 py-1'>PAID</button></td>                    
                    <td className="text-center p-4"><button className='text-white text-sm font-bold rounded-2xl bg-[#901111] px-3 py-1'>CANCEL</button></td>
